const CACHE_NAME = 'zelo-cache-v77';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './manifest.json',
    './assets/js/zelo-build.js?v=77',
    './assets/css/style-v5.css?v=77',
    './assets/js/i18n.js?v=77',
    './assets/js/app-v5.js?v=77',
    './assets/js/api-v5.js?v=77',
    './assets/js/map-manager.js?v=77',
