const CACHE_NAME = 'zelo-cache-v175';
const ASSETS_TO_CACHE = [
    './',
    './index.html',
    './manifest.json',
    './assets/js/zelo-build.js?v=175',
    './assets/css/style-v5.css?v=175',
    './assets/js/i18n.js?v=175',
    './assets/js/app-v5.js?v=175',
    './assets/js/api-v5.js?v=175',
    './assets/js/map-manager.js?v=175',
