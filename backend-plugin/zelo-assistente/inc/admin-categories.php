...
function zelo_get_default_categories_map() {
	return array(
		'farmacia'   => array( 'label' => 'Farmácia',    'google_types' => array( 'pharmacy' ) ),
		'hospital'   => array( 'label' => 'Hospital',    'google_types' => array( 'hospital' ) ),
		'emergencia' => array( 'label' => 'Emergência',  'google_types' => array( 'hospital', 'fire_station' ) ),
		'cultura'    => array( 'label' => 'Cultura',     'google_types' => array( 'museum', 'art_gallery', 'tourist_attraction' ) ),
		'compras'    => array( 'label' => 'Compras',     'google_types' => array( 'shopping_mall', 'store', 'supermarket' ) ),
		'lazer'      => array( 'label' => 'Lazer',       'google_types' => array( 'park', 'stadium', 'amusement_park' ) ),
	);
}
