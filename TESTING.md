...
| 2z7j | **Export PDF legenda por pavimento + cabeçalho logo** (#66, plugin **2.26.5+**) | manage_options / `zelo_manage_ops` | Fundo overlay só atrás do texto; sem faixa branca vazia; «LEGENDA (FACILIDADES)» visível; Piso 3+ na pág. 1 ou pág. 2 |
