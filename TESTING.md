...
| 2z7j | **Export PDF legenda por pavimento + cabeçalho logo** (#66, plugin **2.26.0+**) | manage_options / `zelo_manage_ops` | Logo + «Mapa» + nome evento; legenda agrupada Sub-solo/Piso N; mapa ~230 mm; coluna ~50 mm; ruas visíveis; sem «Página X de Y»; overflow → pág. 2 |
