...
| 2z7j | **Export PDF legenda por pavimento + cabeçalho logo** (#66, plugin **2.26.4+**) | manage_options / `zelo_manage_ops` | Título fixo; legenda overlay até ~20 mm acima de «LEGENDA (FACILIDADES)»; Piso 3/Sub-solo na pág. 1 se couber; overflow → pág. 2 |
