...
| 2z7j | **Export PDF legenda por pavimento + cabeçalho logo** (#66, plugin **2.26.1+**) | manage_options / `zelo_manage_ops` | Logo ~16 mm; título uma linha «Mapa {evento}» (nome em Configurações do Evento); mapa ~281 mm; legenda overlay ~50 mm (fundo branco) até margem direita; grupos por pavimento; ruas esquerda/topo visíveis; sem «Página X de Y»; overflow → pág. 2 |
