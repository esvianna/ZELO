...
| 2z7j | **Export PDF legenda por pavimento + cabeçalho logo** (#66, plugin **2.26.2+**) | manage_options / `zelo_manage_ops` | Logo ~16 mm; título uma linha «Mapa {evento}»; mapa ~281 mm **alinhado à esquerda**; legenda overlay ~50 mm; «Rua Buenos Aires» visível; sem «Página X de Y»; overflow → pág. 2 |
