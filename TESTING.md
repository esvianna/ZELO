...
| 2z7j | **Export PDF legenda por pavimento + cabeçalho logo** (#66, plugin **2.26.3+**) | manage_options / `zelo_manage_ops` | Título fixo «Mapa Congresso Internacional Curitiba 2026»; mapa alinhado à esquerda; legenda overlay não cobre «LEGENDA (FACILIDADES)» do diagrama; overflow → pág. 2 |
