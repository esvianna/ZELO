...
>
> Última atualização: **2026-06-25** — #64 PDF mapa maior plugin **2.24.3** **In review**.
...
|--------------------|--------|
| Plugin WordPress (`zelo-assistente.php`) | **2.24.3** |
...
| Issue | Estado | Notas |
|-------|--------|-------|
| [#64](https://github.com/esvianna/ZELO/issues/64) | **In review** | PDF legenda lateral + mapa maior + pinos 2× — plugin **2.24.3**; smoke **2z7c–2z7d** |
...
1. Smoke **#64** PDF mapa maior (`TESTING.md` **2z7d**) após deploy plugin **2.24.3**.
...
- **#64:** PDF mapa maior (~227 mm), legenda 2 colunas, pinos 2× + TTF — plugin **2.24.3** — **In review**; smoke **2z7d**.
